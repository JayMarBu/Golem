...
// this file is an exact copy of backends/imgui_impl_vulkan
// edited line 1449 to allow multi viewport support. would be nice if this worked out of the box, but here we are

#include "golpch.h"
#include "ViewportFriendlyImGuiVulkanImpl.h"
#include <stdio.h>
